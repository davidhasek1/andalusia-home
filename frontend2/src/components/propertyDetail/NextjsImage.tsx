...
import { isImageFitCover, useLightboxProps, useLightboxState, isImageSlide, Slide, SlideImage } from 'yet-another-react-lightbox';

function isNextJsImage(slide: Slide): slide is StaticImageData {
	return isImageSlide(slide) && typeof slide.width === 'number' && typeof slide.height === 'number';
}

//NOTE: Adjusted RenderSlideProps
type Props = Readonly<{ slide: SlideImage; offset?: number; rect: { width: number; height: number } }>;
